...
export default function CollectionsContent() {
  ...
  const collections = [
    ...
    { id: 'fw23-new-elegance', title: 'FW23 New Elegance', season: 'Jesen/Zima', year: '2023', image: 'Bomber_Jakna_in_krilo_Elena_New_Elegance_6_gdtdiv' },
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center text-center text-white overflow-hidden">
          <div className="absolute inset-0">
            <CloudinaryImage
              src="HeartstringsOfPassion__26_tg99tm"
              ...
              priority
            />
            <div className="absolute inset-0 bg-linear-to-b from-black/60 via-tertiary/30 to-black/50" />
          </div>
